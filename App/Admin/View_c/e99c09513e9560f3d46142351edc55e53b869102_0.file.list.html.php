<?php
/* Smarty version 3.1.30, created on 2018-04-17 14:37:25
  from "D:\class\two_class\dytt\App\Admin\View\Film\list.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ad59625ebcc04_12084397',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e99c09513e9560f3d46142351edc55e53b869102' => 
    array (
      0 => 'D:\\class\\two_class\\dytt\\App\\Admin\\View\\Film\\list.html',
      1 => 1523947044,
      2 => 'file',
    ),
  ),
...
function content_5ad59625ebcc04_12084397 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
					...
					<div class="Mian-cont-wrap">
						<div class="defaultTab-T">
							<table border="0" cellspacing="0" cellpadding="0" class="defaultTable">
								<tbody><tr><th class="t_1">影片ID</th><th class="t_2_1">影片名称</th><th class="t_3">上映日期</th><th class="t_5">影片类型</th><th class="t_4">操作</th></tr>
							</tbody></table>
						</div>
						<table border="0" cellspacing="0" cellpadding="0" class="defaultTable defaultTable2">
							<tbody>
							<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['FilmArr']->value['data'], 'v');
if ($_from !== null) {
...
?>
							<tr>
								...
								<td class="t_4"><div class="btn"><a class="Top">置顶</a>
									<a href="#" class="modify">修改</a>
									<a href="index.php?p=admin&c=Film&a=deleteType&id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
...
?>
						...
						<!--pages S-->
						<?php echo $_smarty_tpl->tpl_vars['FilmArr']->value['pages'];?>
