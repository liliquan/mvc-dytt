<?php
/* Smarty version 3.1.30, created on 2018-04-16 11:17:34
  from "D:\class\two_class\dytt\App\Admin\View\Rules\edit.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ad415ce38f088_57929102',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '268d1927423bdafe3a67d2a149cc31f0fdbb0fd1' => 
    array (
      0 => 'D:\\class\\two_class\\dytt\\App\\Admin\\View\\Rules\\edit.html',
      1 => 1523848645,
      2 => 'file',
    ),
  ),
...
function content_5ad415ce38f088_57929102 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
		...
		<div class="superCtab">
			<div class="publishArt">
				...
				<div class="pubMain">
					...
					<form action="index.php?p=admin&c=Rules&a=doUpdata" method="post">
...
"  <?php if ($_smarty_tpl->tpl_vars['rules']->value['filmtypeid'] == $_smarty_tpl->tpl_vars['v']->value['path']) {?> selected<?php }?>>
...
?>
								...
								<option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" <?php if ($_smarty_tpl->tpl_vars['rules']->value['filmtypeid'] == $_smarty_tpl->tpl_vars['v']->value['id']) {?> selected<?php }?> >
...
?>
						...
						<div class="pub-txt-bar">
							<input type="text" class="shuruTxt" name="rulesname" value="<?php echo $_smarty_tpl->tpl_vars['rules']->value['rules_name'];?>
">
						</div>
...
">
						...
						<div class="pub-txt-bar">
							<input type="radio" name="rulestype" value="1" checked="checked">内容
							<input type="radio" name="rulestype" value="2">列表
						</div>
						...
						<div class="pub-btn">
							<input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['rules']->value['id'];?>
" name="id">
